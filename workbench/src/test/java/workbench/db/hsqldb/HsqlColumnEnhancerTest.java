  ...
  extends WbTestCase
{
    ...
    throws Exception
  {
    ...
    for (ColumnIdentifier col : cols)
    {
      ...
      {
        assertEquals("GENERATED ALWAYS AS (ID*3)", col.getGenerationExpression());
      }
      if ("id3".equalsIgnoreCase(name))
      {
        assertEquals("GENERATED ALWAYS AS IDENTITY (START WITH 24 INCREMENT BY 42)", col.getGenerationExpression());
      }
    }
    ...
    throws Exception
  {
    ...
    if (JdbcUtils.hasMinimumServerVersion(con, "2.2"))
    {
      ...
      assertEquals("GENERATED BY DEFAULT AS SEQUENCE SEQ_COMPANY_ID", column.getGenerationExpression());
    }
    else
    {
