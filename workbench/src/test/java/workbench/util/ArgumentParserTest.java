  ...
  extends WbTestCase
{
  ...
  public void testMapValue()
  {
    ...
    arg.addArgument("mapping", ArgumentType.Repeatable);
    arg.parse("-mapping=a1:c1,a2:c2");
    Map<String, String> attr = arg.getMapValue("mapping");
    assertEquals(2, attr.size());
    assertEquals("c1", attr.get("a1"));
    assertEquals("c2", attr.get("a2"));

    arg.parse("-mapping=a1:c1,a2:c2 -mapping=at3:ci3");
    attr = arg.getMapValue("mapping");
    assertEquals(3, attr.size());
    assertEquals("c1", attr.get("a1"));
    assertEquals("c2", attr.get("a2"));
    assertEquals("ci3", attr.get("at3"));
  }
