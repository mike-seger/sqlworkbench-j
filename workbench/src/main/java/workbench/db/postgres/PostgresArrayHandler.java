  ...
  implements ArrayValueHandler
{
  ...
  private void initialize(WbConnection connection)
  {
    ...
    {
      LogMgr.logError(new CallerInfo(){}, "Could not access PGObject", t);
    }
  }
  ...
  private Object createPgObject(Object data, String userType)
  {
    ...
    {
      LogMgr.logDebug(new CallerInfo(){}, "No mapping for type: " + userType);
      return data;
    }
    ...
    {
      LogMgr.logWarning(new CallerInfo(){}, "Could not create instance of PGobject", th);
      return data;
    }
  }
