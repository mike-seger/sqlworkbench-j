  ...
  implements StatementHook
{
  ...
  private List<String> getMessages(WbConnection conn)
  {
    ...
    {
      LogMgr.logError(new CallerInfo(){},"Could not retrieve messages", th);
      setUnavailable();
    }
  ...
  private synchronized void initialize(WbConnection conn)
  {
    ...
    {
      LogMgr.logError(new CallerInfo(){}, "Could not obtain getNotifications() method", t);
  ...
  private synchronized void initGetters(Object notification)
  {
    ...
    {
      LogMgr.logError(new CallerInfo(){}, "Could not obtain methods from PGNotification interface", th);
      setUnavailable();
    }
  }
