...
public class TableDependencySorter
{
  ...
  private List<DependencyNode> collectRoots(List<TableIdentifier> tables)
  {
    ...
    for (TableIdentifier tbl : tables)
    {
      ...
      {
        LogMgr.logDebug(new CallerInfo(){}, "Re-using child tree for " + tbl + " with level: " + root.getLevel());
      }
  ...
  public static List<TableIdentifier> sortTables(Collection<DependencyNode> allNodes, Collection<TableIdentifier> tables, boolean bottomUp)
  {
    ...
    LogMgr.logDebug(new CallerInfo(){}, "Sorting " + sorted.size() + " tables took " + duration + "ms");
    return sorted;
  }
