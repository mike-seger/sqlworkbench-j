...
public class OracleExternalTableReader
{
  ...
  public CharSequence getDefinition(TableIdentifier table, WbConnection conn)
  {
    ...
    LogMgr.logMetadataSql(new CallerInfo(){}, "external table definition",  baseSql, table.getRawSchema(), table.getRawTableName());
    ...
    {
      LogMgr.logMetadataError(new CallerInfo(){}, sql, "external table definition",  baseSql, table.getRawSchema(), table.getRawTableName());
    }
    finally
    {
