  ...
  extends RegexErrorPositionReader
{
   ...
   *
   * See: https://docs.oracle.com/cd/E11882_01/appdev.112/e25788/d_sql.htm#i997676
   *
  ...
  public ErrorDescriptor getErrorPosition(WbConnection con, String sql, Exception ex)
  {
    ...
    {
      LogMgr.logDebug(new CallerInfo(){}, "Could not retrieve error offset", e);
    }
    finally
    {
    ...
    if (errorPos > -1)
    {
      LogMgr.logDebug(new CallerInfo(){}, "Error at position: " + errorPos + " reported by Oracle");
