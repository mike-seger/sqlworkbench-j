  ...
  extends DefaultFKHandler
{
    ...
    throws SQLException
  {
    ...
    LogMgr.logMetadataSql(new CallerInfo(){}, "exported foreign keys", sql, tbl.getRawTableName(), tbl.getRawSchema());
    ...
    throws SQLException
  {
    ...
    LogMgr.logMetadataSql(new CallerInfo(){}, "imported foreign keys", sql, tbl.getRawTableName(), tbl.getRawSchema());
  ...
  private DataStore readUserFK(String owner)
  {
    ...
    LogMgr.logMetadataSql(new CallerInfo(){}, "foreign keys", sql);
    ...
    try
    {
      ...
      LogMgr.logDebug(new CallerInfo(){}, "Retrieving foreign keys for " + owner + " took: " + duration + "ms");
    }
    catch (Exception ex)
    {
      LogMgr.logMetadataError(new CallerInfo(){}, ex, "foreign keys", sql);
      return null;
    }
    finally
    {
