...
/*
 * This class is taken from: https://github.com/paour/natorder
 *
 * Changes to the original implementation done for SQL Workbench/J:
 *
 * - remove demo methods.
 * - changed static methods to instance methods
 * - implement Comparator<String> instead of just Comparator
  ...
  implements Comparator<String>
{
  ...
  {
    return compare(a, b, this.ignoreCase);
  }
