  ...
  implements ActionListener
{
  ...
  public void restoreSettings(String settingsKey)
  {
    if (StringUtil.isBlank(settingsKey)) return;
    Settings settings = Settings.getInstance();
    String prefix = "workbench.gui.columnselector." + settingsKey.toLowerCase() + ".";
    if (formatText != null)
    {
      formatText.setSelected(settings.getBoolProperty(prefix + "formattext", false));
    }
    if (includeHeaderCheckBox != null)
    {
      includeHeaderCheckBox.setSelected(settings.getBoolProperty(prefix + "includeheader", false));
    }
    if (selectedOnlyCheckBox != null)
    {
      selectedOnlyCheckBox.setSelected(settings.getBoolProperty(prefix + "selectedonly", false));
    }
  }

  public void saveSettings(String settingsKey)
  {
    if (StringUtil.isBlank(settingsKey)) return;
    ...
    if (formatText != null)
    {
      settings.setProperty(prefix + "formattext", formatTextOutput());
    }
    if (includeHeaderCheckBox != null)
    {
      settings.setProperty(prefix + "includeheader", includeHeader());
    }
    if (selectedOnlyCheckBox != null)
    {
      settings.setProperty(prefix + "selectedonly", selectedOnly());
    }
  }
