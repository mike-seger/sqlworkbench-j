 ...
 * <P>
 * Taken from: https://tips4java.wordpress.com/2009/02/01/menu-scroller/
 *
...
public class MenuScroller
{
  ...
  /**
   * Constructs a
   * <code>MenuScroller</code> that scrolls a menu with the
  ...
  /**
   * Constructs a
   * <code>MenuScroller</code> that scrolls a popup menu with the
   * default number of items to display at a time, and default scrolling
   * interval.
   *
   * @param menu the popup menu
   ...
   * negative or if topFixedCount or bottomFixedCount is negative
   */
  public MenuScroller(JPopupMenu toScroll, int scrollCount, int interval, int topFixedCount, int bottomFixedCount)
  {
    ...
    this.menu = toScroll;
    this.menu.addPopupMenuListener(menuListener);
  }
   ...
   * method with
   * <code>-1</code> to restore the default behavior, which is to show the menu as
   * it last appeared.
   *
