 ...
 */
package workbench.sql.generator.insert;
 ...
 */
public class SQLAnywhereInsertGenerator
  extends DefaultInsertGenerator
{
  public SQLAnywhereInsertGenerator(TableIdentifier table, List<ColumnIdentifier> targetColumns)
  {
    super(table, targetColumns);
  }

  public SQLAnywhereInsertGenerator(TableIdentifier table, List<ColumnIdentifier> targetColumns, WbConnection conn)
  {
  ...
  protected CharSequence createValuesStart()
  {
    ...
    return super.createValuesStart();
  }
